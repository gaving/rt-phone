...
//
//  The sole responsibility of the Connector is to communicate with to the
//  iProtect web service. It passes on data sent to it from the application or
//  web server.  It does no direct processing on the data.
